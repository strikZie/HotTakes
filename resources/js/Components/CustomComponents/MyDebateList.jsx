...
function MyDebateList({classname}) {
    return (
        <div className="w-full h-full bg-white ">
            <div className={classname+" text-xl font-bold ml-3 mr-3 " +
                "flex  items-center justify-center drop-shadow-md shadow-xl " +
                "rounded border-solid border-2 border-gray-400"}>My Debates</div>
